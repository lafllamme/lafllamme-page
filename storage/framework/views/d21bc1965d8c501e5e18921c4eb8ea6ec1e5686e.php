                        ...
                        <ul>
                            <li class="adobe-product">
                                ...
                                <div class="button-wrapper">
                                    <button class="content-button status-button" onclick="location.href='https://spoti.fi/3L84OPL'">Open</button>
                                    <div class="menu">
                        ...
                        <div class="apps-card">
                            <div class="app-card">
                                ...
                                <div class="app-card-buttons">
                                    <button class="content-button status-button"><?php echo e(date('l/M/y')); ?></button>
                                    <div class="menu"></div>
                                </div>
                            </div>
                            <div class="app-card">
